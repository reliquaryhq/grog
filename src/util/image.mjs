...
const downloadImageFile = async (entry, downloadRoot, agent, onHeaders, onProgress) => {
  ...
  if (await fs.pathExists(downloadPath)) {
    ...
    const cdnFile = await db.image.getImageFile({ path: url.pathname });
    ...
    await db.image.createImageFile({
